...
import { ClockIcon, PlusIcon, ListBulletIcon } from '@heroicons/react/24/outline'
...
export default function GuestVisitsRoute(): JSX.Element {
  ...
  const handleVisitCreated = (visit: GuestVisit) => {
    console.log('Guest visit created:', visit)
    if (activeView === 'list') {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-neutral-600 mt-2">
            Manage guest visits and check-ins
          </p>
        </div>
        ...
        <div className="bg-white rounded-xl border border-neutral-200 p-8">
          <div className="mb-6">
            <h2 className="text-xl font-semibold text-neutral-900 mb-2">
              Create New Guest Visit
            </h2>
            <p className="text-sm text-neutral-600">
              Register a new guest visit (check-in).
            </p>
          </div>
          <GuestVisitForm
      ...
      {activeView === 'list' && (
        <div className="bg-white rounded-xl border border-neutral-200 p-8">
          <div className="mb-6">
            ...
            <p className="text-sm text-neutral-600">
              View and manage all guest visits.
            </p>
          </div>
          <GuestVisitList
            key={refreshKey}
